            ...
            <div className="bg-white rounded-lg shadow-lg w-full relative">
                <div className="p-4">
                    <div className="mb-4">
                        ...
                        {/* <span className="font-bold mr-16">Step 1:</span>
                            <span className="font-bold mr-16" >Step 2:</span>
                            <span className="font-bold ">Step 3:</span>
                            <span className="font-bold ml-24">Step 4:</span> */}
                    ...
                    {selectedComponent === "AddressEntryComponent" && <AddressEntryComponent onSubmit={handleAddressSubmit} id={id} />}
